    ...
    <div class="container mx-auto mt-6">
      ...
      <div class="max-w-md mx-auto">
        <div class="bg-white p-4 rounded-lg shadow-md">
          <h1 class="text-2xl font-semibold mb-4">Edit Game</h1>
          <form @submit.prevent="updateGame">
            ...
            <div class="mb-4">
              ...
              <select id="type" v-model="form.type" required class="mt-1 p-2 w-full border rounded-md">
                ...
                <option value="Melee Hero">Melee Hero</option>
                <option value="Range Hero">Range Hero</option>
              </select>
            </div>
            <div class="mb-4">
